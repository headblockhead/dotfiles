  ...
  services.dnsmasq = {
    ...
    settings = {
      ...
      dhcp-host = [
        ...
        "e4:5f:01:11:a6:8e,192.168.1.100,homeassistant"
        "a8:13:74:17:b6:18,192.168.1.101,hesketh-tv"
        "4c:b9:ea:5a:4f:03,192.168.1.102,scuttlebug"
        "0c:fe:45:1d:e6:66,192.168.1.103,ps4"
        "dc:a6:32:31:50:3c,192.168.1.104,printerpi"
        "00:0b:81:87:e5:5f,192.168.1.105,officepi"
        "d8:3a:dd:97:a9:c4,192.168.1.106,rpi-builder"
      ];
    };
  };
}
