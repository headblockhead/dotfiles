      ...
      ruleset = ''
        table inet filter {
          ...
          chain forward {
            ...
            iifname "${iot_port}" oifname "${lan_port}" tcp sport { 8123, 4357 } ip saddr 192.168.2.100 ct state { established, related } accept comment "Allow established Home Assistant back to LAN"
