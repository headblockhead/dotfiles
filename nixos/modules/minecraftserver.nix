{ config, pkgs, inputs, ...}:
{
  ...
  symlinks = {
    mods = pkgs.linkFarmFromDrvs "mods" (builtins.attrValues {
      ...
      ProxyProtocolSupport = pkgs.fetchurl { url="https://mediafilez.forgecdn.net/files/4421/426/proxy_protocol_support-1.0.3-fabric.jar"; sha256="JhKXS17NYeo2hjoEHDPz9BPCTG8Xhf7Ij/L/YM8/uZU="; };
